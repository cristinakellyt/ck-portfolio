...
const projectCardContent = [
  {
    name: 'Charge Guard',
    description: 'A CMS to control charging stations for electric cars. Check the CMS with the following credentials: login:admin@admin / password:admin',
  ...
  {
    name: 'House Company',
    description: 'A project where the user can see available houses, search by city, filter them by price, location, and number of rooms. It is also possible to place new houses for sale through a form where the user provides all the information, being able to edit or delete it later',
  ...
  {
    name: 'Check Weather',
    description: 'The user can see the weather information of a location by searching it by name. It also allows users to save the location and view their current weather on the home page.',
  ...
  },
  {
    ...
    description: 'In this project, the user can see available movies and tv-series, search and save them.',
  ...
  {
    name: 'Pomodoro',
    description: 'This is a Pomodoro timer where the user can set the time for work and break (short or long). The user can pause, reset and set the minutes for the timer.',
  ...
  {
    name: 'Summary Card',
    description: 'A project where the user can select the type of its order and fill in the form of payment details.',
